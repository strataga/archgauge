...
Trust boundaries: browser/API; tenant/application/database; untrusted repository/ingestion; ArchGauge/model provider; worker/queue; CI/release registry; operator portal.
